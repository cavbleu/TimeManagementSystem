...
* Скачать проект
* Запустить файл docker-compose.yml с помощью кнопки из IntellijIdea или с помощью терминала, набрав команду docker-compose up --build. БД развернется автоматически
* Перейти по ссылке http://localhost:3000/

**Приложение делится на 8 основных вкладок:**
