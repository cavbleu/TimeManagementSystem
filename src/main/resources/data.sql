...
VALUES (1, 32, 'Алексей Никифоров', 5, 5),
       ...
       (4, 50, 'Александр Бирюков', 3, null),
       (5, 34, 'Дмитрий Куплинов', 8, null),
       (6, 31, 'Елена Зайцева', 1, null),
       (7, 25, 'Анастасия Макарова', 2, null),
       (8, 37, 'Кристина Алексеева', 3, null),
       (9, 42, 'Михаил Мишустин', 4, null);
