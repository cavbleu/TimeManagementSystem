...
class CreateOrUpdateTimeSheetComponent extends Component {
	constructor(props) {
		super(props)
	...
	getTitle() {
		if (this.state.id != "add") {
			...
			return (
				<h3 style={{ textAlign: "center" }}>
					Добавление нового табеля рабочего времени
				</h3>
			)
		}
	}
							...
							<form>
								...
								<div>
									<label style={{ fontSize: 20, marginTop: 20 }}>
										Время начала рабочего дня в формате "чч:мм":
									</label>
									<input
										style={{ marginTop: 10 }}
										className='form-control'
								...
								<div>
									<label style={{ fontSize: 20, marginTop: 20 }}>
										Время окончания рабочего дня в формате "чч:мм":
									</label>
									<input
										style={{ marginTop: 10 }}
										className='form-control'
								...
								<div>
									...
									<input
										style={{ marginTop: 10 }}
										className='form-control'
										value={this.state.absenceReason}
										onChange={event => {
											this.setState({ absenceReason: event.target.value })
										}}
									/>
								</div>
...
export default CreateOrUpdateTimeSheetComponent
