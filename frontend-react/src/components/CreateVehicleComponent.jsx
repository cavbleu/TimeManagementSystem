...
//
//         if (this.state.id === '_add') {
//             VehicleService.createVehicle(vehicle).catch((err) => {
//                 console.log(err);
//                 if (err.status = 404) {
...
//                                     <label>Марка: </label>
//                                     <input placeholder='Марка' name='brand' className='form-control'
//                                            value={this.state.brand} onChange={this.changeBrandHandler}/>
//                                 </div>
//                                 <div className='form-group'>
//                                     <label>Модель: </label>
//                                     <input placeholder='Модель' name='model' className='form-control'
//                                            value={this.state.model} onChange={this.changeModelHandler}/>
//                                 </div>
//                                 <div className='form-group'>
//                                     <label>Категория: </label>
//                                     <input placeholder='Категория' name='category' className='form-control'
//                                            value={this.state.category} onChange={this.changeCategoryHandler}/>
//                                 </div>
//                                 <div className='form-group'>
//                                     <label>Гос. номер: </label>
//                                     <input placeholder='Гос. номер' name='gosNumber' className='form-control'
//                                            value={this.state.gosNumber} onChange={this.changeGosNumberHandler}/>
//                                 </div>
//                                 <div className='form-group'>
//                                     <label>Год выпуска: </label>
//                                     <input placeholder='Год выпуска' name='productionYear' className='form-control'
//                                            value={this.state.productionYear}
//                                            onChange={this.changeProductionYearHandler}/>
//                                 </div>
//                                 <div style={{marginTop: '5px'}}>
//                                     <label htmlFor="dog-names">Тип ТС:</label>
//                                     <select style={{marginLeft: '3px'}} onSubmit={this.changeVehicleType}>
...
//                                     <button style={{marginTop: '5px'}} className='btn btn-success'
//                                             onClick={this.saveOrUpdateDepartment}>Сохранить
//                                     </button>
//                                     <button className='btn btn-primary' onClick={this.cancel}
//                                             style={{marginLeft: "10px", marginTop: '5px'}}>Назад
//                                     </button>
//                                 </div>
//                             </form>
//                         </div>
